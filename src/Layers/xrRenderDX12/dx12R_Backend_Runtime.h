...
IC D3D12_PRIMITIVE_TOPOLOGY TranslateTopology(D3DPRIMITIVETYPE T)
{
    ...
    {
        D3D12_PRIMITIVE_TOPOLOGY_UNDEFINED,
        D3D12_PRIMITIVE_TOPOLOGY_POINT_LIST,
        D3D12_PRIMITIVE_TOPOLOGY_LINE_LIST,
        D3D12_PRIMITIVE_TOPOLOGY_LINE_STRIP,
        D3D12_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST,
        D3D12_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP,
        D3D12_PRIMITIVE_TOPOLOGY_UNDEFINED,
    };
    ...
    VERIFY(result != D3D12_PRIMITIVE_TOPOLOGY_UNDEFINED);
...
IC void CBackend::Render(D3DPRIMITIVETYPE T, u32 baseV, u32 startV, u32 countV, u32 startI, u32 PC)
{
    ...
    if (hs != 0 || ds != 0)
    {
        R_ASSERT(Topology == D3D12_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST);
        Topology = D3D12_PRIMITIVE_TOPOLOGY_3_CONTROL_POINT_PATCHLIST;
    }
