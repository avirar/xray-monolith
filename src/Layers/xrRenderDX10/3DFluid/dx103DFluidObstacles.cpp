...
void dx103DFluidObstacles::ProcessDynamicObstacles(const dx103DFluidData& FluidData, const Fmatrix& WorldToFluid,
                                                   float timestep)
{
...
void dx103DFluidObstacles::RenderPhysicsElement(const IPhysicsElement& Element, const Fmatrix& WorldToFluid,
                                                float timestep)
{
	//	Shader must be already set up!
...
void dx103DFluidObstacles::RenderDynamicOOBB(const IPhysicsGeometry& Geometry, const Fmatrix& WorldToFluid,
                                             float timestep)
{
	PIX_EVENT(RenderDynamicObstacle);
